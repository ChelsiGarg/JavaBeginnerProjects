    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(command.equals("Reset") || command.equals("Restart")){
            ...
            if(wordChallenge[1].contains(command)){
                ...
                // indicate that the user chose the wromg letter
