...
public class TicTacToeGui extends JFrame implements ActionListener{
    // xScore - holds the score value of player x
    // oScore - holds the score value of player o
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(command.equals("Reset") || command.equals("Play Again")){
            ...
            if(button.getText().equals("")){
                ...
                if(isPlayerOne){
                    // check to see if last move from o was the winning move
                    checkOWin();
                }else{
                    // check to see if last move from X was the winning move
                    checkXWin();
                }
            }
    ...
    private void checkDraw(){
        // if there a total of 9 moves & no player has won yet then it means there is a draw
        if(moveCounter>=9){ 
